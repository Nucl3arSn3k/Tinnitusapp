...
import 'package:ownthetone/pages/3Screen.dart';
...
void main() =>
    runApp(MaterialApp(title: "Own the Tone", home: MainPersistentTabBar3()));

class MainPersistentTabBar3 extends StatefulWidget {
  @override
  MainPersistentTabBarState2 createState() => MainPersistentTabBarState2();
}

class MainPersistentTabBarState2 extends State<MainPersistentTabBar3> {
