...
import 'package:ownthetone/pages/4Screen.dart';
...
void main() =>
    runApp(MaterialApp(title: "Own the Tone", home: MainPersistentTabBar4()));

class MainPersistentTabBar4 extends StatefulWidget {
  @override
  MainPersistentTabBarState2 createState() => MainPersistentTabBarState2();
}

class MainPersistentTabBarState2 extends State<MainPersistentTabBar4> {
